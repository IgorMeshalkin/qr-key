...
export default function IgorPage() {
    ...
    const content = {
        ...
        thai: {
            title: 'สวัสดีครับ!🤚 ผมชื่ออิกอร์',
            description: 'ดูเหมือนว่าคุณจะพบกุญแจของผม',
            value: 'กรุณาติดต่อผมด้วยวิธีที่สะดวกสำหรับคุณ:'
        }
    }
    ...
    const handleClick = (way) => {
        switch (way) {
            case 'telegram':
                window.open('https://t.me/meshalkin27', '_blank')
                break;
            case 'whats-app':
                window.open('https://wa.me/+84782240721', '_blank')
                break;
            case 'line':
                window.open('https://line.me/ti/p/~meshalkin27', '_blank')
                break;
            case 'phone':
                window.open('tel:0610586030', '_blank')
                break;
            default:
                break;
        }
    ...
    return (
        <div style={{
            ...
            <h1 style={{color: "white", textAlign: 'center', width: '100%'}}>{content[language].title}</h1>
            <span style={{
                color: "white",
                fontSize: '1.3rem',
                fontWeight: 500,
